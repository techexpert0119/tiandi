...
<html lang="en"> 
  ...
  <?
  $globvars['debug'] = 0 ;
  $globvars['sq_table'] = 'faqs'; // table name
  ...
  $globvars['sq_keys'] = array('lkua','lce','le','ey'); // field keys
  $globvars['sq_names'] = array(' ','Order','Question','Answer'); // field names
  ...
  $globvars['ptitle'] =  'FAQs' ; // page title
