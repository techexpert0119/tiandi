...
<html lang="en"> 
  ...
  <?
  $globvars['debug'] = 0 ;
  $globvars['sq_table'] = 'social'; // table name
  ...
  $globvars['sq_keys'] = array('lkua','lec','lef','le','le'); // field keys
  $globvars['sq_names'] = array(' '); // field names
  $globvars['sq_notes'] = array('','','','','Icon hidden if blank'); // field notes
  ...
  $globvars['ptitle'] =  'Social Media' ; // page title
  ...
  $globvars['filepath'] = '../images/social' ; // file path
