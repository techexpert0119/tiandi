...
<html lang="en"> 
  ...
  <?
  $globvars['debug'] = 0 ;
  $globvars['sq_table'] = 'shop_brands'; // table name
  ...
  $globvars['sq_keys'] = array('lkua','le'); // field keys
  $globvars['sq_names'] = array(' ','Name'); // field names
  ...
  $globvars['sq_dsort'] = 'b_name'; // default sort (reverse _DESC)
  $globvars['sq_ajoin'] = "" ; // join filter string for list
 
  $globvars['plogo'] = $globvars['admin_logo'] ; // logo
  $globvars['ptitle'] =  'Shop Brands' ; // page title
  $globvars['adminm'] = 'index.php' ; // admin menu
  $globvars['public'] = '../shop' ; // public page
