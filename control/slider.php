...
<html lang="en"> 
  ...
  <?
  $globvars['debug'] = 0 ;
  $globvars['sq_table'] = 'slider'; // table name
  ...
  $globvars['sq_keys'] = array('lkua','lecn','le','ey','ef','e'); // field keys
  ...
  $globvars['ptitle'] =  'Slider' ; // page title
  ...
  $globvars['filepath'] = '../images/slider' ; // file path
