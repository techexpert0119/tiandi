...
<html lang="en"> 
  ...
  <?
  $globvars['debug'] = 0 ;
  $globvars['sq_table'] = 'wishlist'; // table name
  ...
  $globvars['sq_keys'] = array('lkua','lvo','lvo','lvo','lv'); // field keys
  $globvars['sq_names'] = array(' ','Email','Item','Option','Added'); // field names
  $globvars['sq_notes'] = array(); // field notes
  $globvars['sq_notei'] = array(); // popup image
  $globvars['sq_lookt'] = array('','user_details','shop_items','shop_options',''); // opt tables
  $globvars['sq_lookk'] = array('','u_id','i_id','o_id',''); // opt keys
  $globvars['sq_lookv'] = array('','u_email','i_head','o_option1',''); // opt values
  $globvars['sq_lookd'] = array('','v','v','[[o_option1]] | [[o_option2]]',''); // eg. 'k : v' or [[field]]
  ...
  $globvars['sq_dsort'] = 'w_date_DESC'; // default sort (reverse _DESC)
  $globvars['sq_ajoin'] = "" ; // join filter string for list
 
  $globvars['plogo'] = $globvars['admin_logo'] ; // logo
  $globvars['ptitle'] =  'Wishlist' ; // page title
