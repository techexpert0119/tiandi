...
<html lang="en"> 
  ...
  <?
  $globvars['debug'] = 0 ;
  $globvars['sq_table'] = 'press'; // table name
  ...
  $globvars['sq_keys'] = array('lkua','lecn','le','le','le','le','lef','blef','lef','lef','be'); // field keys
  $globvars['sq_names'] = array(' ','Order','Visible','Date','Title','Text','Front Image','Inner Image 1','Inner Image 2','Inner Image 3','Or external link'); // field names
  $globvars['sq_notes'] = array('','','','','','','Must be exactly 305x400','','','',''); // field notes
  ...
  $globvars['sq_fpath'] = array('','','','','','','front','inner','inner','inner',''); // extra file paths
  ...
  $globvars['sq_funct'] = array('','','','','','','simage','simage','simage','simage',''); // call functions
  ...
  $globvars['sq_dsort'] = 'order,date_DESC'; // default sort (reverse _DESC)
  $globvars['sq_ajoin'] = "" ; // join filter string for list
 
  $globvars['plogo'] = $globvars['admin_logo'] ; // logo
  $globvars['ptitle'] =  'Press' ; // page title
  $globvars['adminm'] = 'index.php' ; // admin menu
  $globvars['public'] = '../international-press' ; // public page
  ...
  $globvars['filepath'] = '../images/press' ; // file path
