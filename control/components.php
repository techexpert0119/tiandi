...
<html lang="en"> 
  ...
  <?
  $globvars['debug'] = 0 ;
  $globvars['sq_table'] = 'components'; // table name
  ...
  $globvars['sq_keys'] = array('lkua','lec','le','le','ey','lef'); // field keys
  $globvars['sq_names'] = array(' ','Order','Visible','Title','Text','Image'); // field names
  $globvars['sq_notes'] = array('','','','','','400x340'); // field notes
  ...
  $globvars['ptitle'] =  'Components' ; // page title
  ...
  $globvars['filepath'] = '../images/product/comp' ; // file path
